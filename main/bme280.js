...
export class Bme280 {
  ...
  async init() {
    ...
    if (chipId !== BME280_CHIP_ID)
      throw new Error(`Invalid chip id: ${chipId}, expected: ${BME280_CHIP_ID}`);
    ...
    this.digH4 = digH4; this.digH5 = digH5;
  ...
  async readTempPressHum() {
    const array = await this.bridge.i2cTransferPacket(
      this.address, new Uint8Array([Bme280Registers.PRESS]).buffer, 8);
  ...
  compensateHum(adcH, tempFine) {
    ...
    var1 = tempFine - 76800;
    var1 = (((adcH << 14) - (this.digH4 << 20) - (this.digH5 * var1) + 16384) >> 15) *
      ((((((var1 * this.digH6) >> 10) * (((var1 * this.digH3) >> 11) + 32768) >> 10) + 2097152) * this.digH2 + 8192) >> 14);
